...
public class BillParser {
	...
	public List<Bill> getBills (Date startDate, Date endDate) throws Throwable {
		...
		DateFormat bdf = new SimpleDateFormat ("EEEE d 'de' MMMM, yyyy", new Locale ("es", "CL"));
		DateFormat dfLey = new SimpleDateFormat ("yyyy-MM-dd");
		NumberFormat nfLey = new DecimalFormat ("###,###,###", new DecimalFormatSymbols (new Locale ("es", "CL")));
